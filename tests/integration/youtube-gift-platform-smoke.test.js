...
describe('YouTube gift platform flow (smoke)', () => {
    ...
    const buildRuntime = (configSnapshot, eventBus, configService, notificationManager, displayQueue, logger, platformLifecycleService) => (
        createTestAppRuntime(configSnapshot, {
            eventBus,
            configService,
            notificationManager,
            displayQueue,
    ...
    it('routes Super Chat gifts through lifecycle, router, and runtime', async () => {
        const {
            displayQueue,
            platformLifecycleService,
            runtimeBundle
    ...
    it('routes Super Sticker gifts through lifecycle, router, and runtime', async () => {
        const {
            displayQueue,
            platformLifecycleService,
            runtimeBundle
