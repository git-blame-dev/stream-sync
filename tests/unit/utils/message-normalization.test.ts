...
} from "../../../src/utils/message-normalization.ts";
beforeEach(() => {
  testClock.reset();
});
...
describe("Message Normalization", () => {
  describe("when normalizing YouTube messages", () => {
      ...
      const chatItem = {
        item: {
          ...
          author: {
            ...
            badges: [],
            thumbnails: [
              { url: "https://example.invalid/youtube-chat-avatar.jpg" },
            ],
          },
    ...
    test("trims YouTube author thumbnail URLs before mapping avatarUrl", () => {
      ...
      const chatItem = {
        item: {
          ...
          author: {
            ...
            thumbnails: [
              {
                url: "  https://example.invalid/youtube-chat-avatar-trim.jpg  ",
              },
            ],
          },
      ...
      expect(normalized.avatarUrl).toBe(
        "https://example.invalid/youtube-chat-avatar-trim.jpg",
      );
    });
    ...
    test("throws on missing YouTube data", () => {
      ...
      expect(() =>
        normalizeYouTubeMessage(incompleteChatItem, "youtube"),
      ...
      const chatItem = {
        item: {
          ...
          author: {
            ...
            name: "newMember",
            is_moderator: false,
            badges: [{ type: "LiveChatAuthorBadge", tooltip: "New member" }],
          },
      ...
      const badgeImages = extractYouTubeBadgeImages({
        badges: [
          ...
          },
          {
            ...
            custom_thumbnail: [
              {
                url: "https://example.invalid/member-s16.png",
                width: 16,
                height: 16,
              },
              {
                url: "https://example.invalid/member-s32.png",
                width: 32,
                height: 32,
              },
            ],
      ...
      expect(normalized.message).toEqual({
        ...
        parts: [
          { type: "text", text: "first " },
          {
            ...
            imageUrl:
              "https://yt3.ggpht.example.invalid/test-one-large=w48-h48-c-k-nd",
          },
          { type: "text", text: "middle " },
          {
            ...
            imageUrl:
              "https://yt3.ggpht.example.invalid/test-two-large=w48-h48-c-k-nd",
          },
          { type: "text", text: "last" },
        ],
      });
        ...
        parts: [
          {
            ...
            imageUrl:
              "https://yt3.ggpht.example.invalid/test-eight=w48-h48-c-k-nd",
          },
        ],
      });
    });
      ...
      expect(normalized.message.parts).toEqual([
        {
          ...
          imageUrl:
            "https://yt3.ggpht.example.invalid/test-three-96=w96-h96-c-k-nd",
        },
      ]);
    });
      ...
      expect(normalized.message.parts).toEqual([
        {
          ...
          imageUrl:
            "https://yt3.ggpht.example.invalid/test-four-first=w24-h24-c-k-nd",
        },
      ]);
    });
            ...
            runs: [
              { text: "hello " },
              {
                emoji: {
                  ...
                  image: [
                    {
                      url: "https://yt3.ggpht.example.invalid/missing-id=w48-h48-c-k-nd",
                      width: 48,
                    },
                  ],
                },
              ...
              {
                emoji: {
                  emoji_id: "UC_TEST_EMOTE_000105/TEST_EMOTE_105",
                  shortcuts: [":missingImage:"],
                  image: [{ url: "   ", width: 48 }],
                },
              },
              {
                emoji: {
                  emoji_id: "UC_TEST_EMOTE_000106/TEST_EMOTE_106",
                  shortcuts: [":valid:"],
                  image: [
                    {
                      url: "https://yt3.ggpht.example.invalid/valid=w48-h48-c-k-nd",
                      width: 48,
                    },
                  ],
                },
        ...
        parts: [
          {
            ...
            imageUrl:
              "https://yt3.ggpht.example.invalid/test-seven=w48-h48-c-k-nd",
          },
        ],
      });
  ...
  describe("when normalizing TikTok messages", () => {
        ...
        user: {
          ...
          badges: [
            ...
            },
            {
              ...
              combine: {
                icon: {
                  url: ["https://example.invalid/tiktok-level-p16.png"],
                },
              },
            },
          ],
    ...
    test("throws on missing TikTok user data", () => {
      ...
      expect(() => normalizeTikTokMessage(incompleteData, "tiktok")).toThrow(
        "userId",
      );
    });
  ...
  describe("Timestamp Preservation Behavior", () => {
    ...
    describe("YouTube Timestamp Preservation", () => {
      ...
      test("throws when YouTube timestamp is missing", () => {
        ...
        expect(() => normalizeYouTubeMessage(youTubeData, "youtube")).toThrow(
          "timestamp",
        );
      });
    });
    ...
    describe("Cross-Platform Timestamp Consistency", () => {
      test("handles timestamp preservation consistently across platforms", () => {
        ...
        const normalizedYouTube = normalizeYouTubeMessage(
          youTubeData,
          "youtube",
        );
