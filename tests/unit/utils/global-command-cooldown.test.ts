...
type GlobalCommandCooldownManagerLike = GlobalCommandCooldownManager;
    ...
    describe("when handling edge cases", () => {
      ...
      describe("and handling command name variations", () => {
        ...
        it("should treat case-sensitive commands as different", () => {
          const lowerResult = cooldownManager.isCommandOnCooldown(
            "!hello",
            5000,
          );
          const upperResult = cooldownManager.isCommandOnCooldown(
            "!HELLO",
            5000,
          );
        ...
        it("should handle commands with spaces", () => {
          ...
          const result = cooldownManager.isCommandOnCooldown(
            "!hello world",
            5000,
          );
          expect(result).toBe(true);
