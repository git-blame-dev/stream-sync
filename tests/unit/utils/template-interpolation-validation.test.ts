...
describe("Template Interpolation Validation", () => {
  describe("interpolateTemplate Function", () => {
    test(
      "should replace single template variable",
      () => {
    ...
    test(
      "should replace multiple template variables",
      () => {
    ...
    test(
      "should handle formattedGiftCountForDisplay variable specifically",
      () => {
    ...
    test(
      "should throw when template variables are missing",
      () => {
        const template = "{username} sent {unknownVariable}";
        const data = { username: "TestUser" };

        expect(() => interpolateTemplate(template, data)).toThrow(
    ...
    test(
      "should throw for empty template",
      () => {
        expect(() => interpolateTemplate("", { username: "test" })).toThrow(
    ...
    test(
      "should throw for null/undefined template",
      () => {
        expect(() => interpolateTemplate(null, { username: "test" })).toThrow(
          "Template must be a string",
        );
        expect(() =>
          interpolateTemplate(undefined, { username: "test" }),
  ...
  describe("Template Data Population", () => {
    test(
      "should populate formattedGiftCountForDisplay in interpolation data",
      () => {
        ...
        expect(result.displayMessage).not.toContain(
    ...
    test(
      "should populate multiple format variables for gift notifications",
      () => {
        const userData = { username: "testuser" };
        const eventData = {
          giftCount: 1,
  ...
  describe("Comprehensive Template Variable Coverage", () => {
    ...
    templateVariables.forEach((variable) => {
      test(
        `should handle ${variable} template variable without exposing placeholder`,
        () => {
  ...
  describe("Real-World Template Patterns", () => {
    test(
      "should handle gift notification template pattern",
      () => {
        const template = "{username} sent {formattedGiftCountForDisplay}";
        const data = {
          username: "sample_handle",
    ...
    test(
      "should handle gift with coins template pattern",
      () => {
        const template =
          "{username} sent {formattedCoins} [{formattedGiftCountForDisplay}]";
        const data = {
          username: "testuser",
    ...
    test(
      "should handle follow notification template pattern",
      () => {
