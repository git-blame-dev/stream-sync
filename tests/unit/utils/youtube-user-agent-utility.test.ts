...
import { YouTubeUserAgentManager } from "../../../src/platforms/youtube/youtube-user-agent-manager";
describe("YouTube User-Agent Utility", () => {
  ...
  describe("User-Agent Management", () => {
    ...
    it("should allow custom user agents to be set", () => {
      const customAgents = ["Custom-Agent/1.0", "Custom-Agent/2.0"];
  ...
  describe("Integration with YouTube Platform", () => {
    ...
    it("should handle concurrent access safely", () => {
      ...
      for (let i = 0; i < 10; i++) {
        promises.push(
          Promise.resolve(String(userAgentManager.getNextUserAgent())),
        );
      }
